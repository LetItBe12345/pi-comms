...
| 18 | [Proactive Agent Participation](./in-progress/18-proactive-agent-participation.md) | 用户显式授权后，由 Broker 使用 DeepSeek-V4-Flash 主动选择最多一个 Agent 参与群聊 | in-progress | 阶段 17 |

## 当前里程碑

阶段 0～16A 已完成。阶段 16B 等待三台真实设备；阶段 17 正在实施；阶段 18 已完成设计并等待实施。
